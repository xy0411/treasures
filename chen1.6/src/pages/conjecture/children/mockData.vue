<template>
  <div class="main">
    ...
    <div class="display" v-for="(it,index) in bannerOptions.productAndImgList" :key="index" :style="{backgroundColor: it.backgroundColor ? it.backgroundColor.pCColor : null}">
